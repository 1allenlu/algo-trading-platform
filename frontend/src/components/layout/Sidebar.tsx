...
const NAV_SECTIONS: NavSection[] = [
  {
    // Always-visible core — the pages you open every day
    heading: 'Core',
    collapsible: false,
    items: [
  ...
  {
    // Analytical tools — open when you're doing research
    heading: 'Research',
    collapsible: true,
    defaultOpen: false,
    items: [
  ...
  {
    // Operational tools — managing your portfolio day-to-day
    heading: 'Manage',
    collapsible: true,
    defaultOpen: false,
    items: [
  ...
  {
    // Power-user features — hidden by default, all routes still work
    heading: 'Advanced',
    collapsible: true,
    defaultOpen: false,
    items: [
      ...
      { label: 'VIX',          path: '/vix',          icon: <VixIcon          sx={{ fontSize: 17 }} /> },
